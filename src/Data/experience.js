const experience = [
    {
        enterprise: "Coppel",
        job: "Vendedor Departamental",
        activities: [
            { activity: "Atención y asesoría a cliente en sus compras" },
        ]
    },
    {
        enterprise: "Tienda Ley",
        job: "Empleado de piso",
        activities: [
            { activity: "Inventario" },
            { activity: "Surtir productos" },
    ...
    },
    {
        ...
        activities: [
            { activity: "Creación y uso de Querys a Bases de Datos SQL, Oracle y MySQL" },
